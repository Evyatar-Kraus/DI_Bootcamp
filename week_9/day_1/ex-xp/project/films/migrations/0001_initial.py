# Generated by Django 3.2.9 on 2021-11-30 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='categories', to='films.Category')),
                ('created_in_country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='films.country')),
                ('director', models.ManyToManyField(related_name='directors', to='films.Director')),
            ],
        ),
    ]
