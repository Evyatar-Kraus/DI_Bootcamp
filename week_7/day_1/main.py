...
def main():
    ...
    new_class = input('would you like to CREATE or IMPORT a classroom (select create/import): ')
    if new_class == 'import':
        filename = input('what file would you like to load? (no extension please)')
    ...
    while True:
        ...
        if choice in 'xX':
            ...
            filename = input('what would you like to name the file? (no extension please)')
